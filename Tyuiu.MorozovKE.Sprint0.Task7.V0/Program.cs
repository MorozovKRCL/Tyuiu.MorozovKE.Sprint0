...
namespace Tyuiu.MorozovKE.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | выполнил Молоров К. Е. | ИБКСб-25-1";
            ...
            Console.WriteLine("* Выполнил: Морозов Кирилл Евгеньевич | ИБКСб-25-1                        *");
            Console.WriteLine("***************************************************************************");
